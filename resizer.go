...
func resizer(buf []byte, o Options) ([]byte, error) {
	...
	//kishor: shrink on load was causing a problem for webp images. Hence disabling it.
	//related issue for jpegs that seems to have been fixed: https://github.com/lovell/sharp/issues/1185
